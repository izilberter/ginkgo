...
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_JACOBI_SMOOTHER_RESIDUAL_KERNEL);
GKO_STUB_VALUE_TYPE(GKO_DECLARE_JACOBI_SMOOTHER_UPDATE_KERNEL);
GKO_STUB_VALUE_TYPE(GKO_DECLARE_JACOBI_SMOOTHER_INVERT_DIAG_KERNEL);
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_JACOBI_SMOOTHER_EXTRACT_DIAG_KERNEL);
...
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_PMIS_COMPUTE_STRONG_GHOST_DEP_KERNEL);
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_PMIS_CLASSIFY_WITH_GHOSTS_KERNEL);
GKO_STUB_VALUE_AND_INDEX_TYPE(
    GKO_DECLARE_PMIS_DIRECT_INTERP_ROW_COUNT_DIST_KERNEL);
GKO_STUB_VALUE_AND_INDEX_TYPE(GKO_DECLARE_PMIS_DIRECT_INTERP_FILL_DIAG_KERNEL);
GKO_STUB_VALUE_AND_INDEX_TYPE(
